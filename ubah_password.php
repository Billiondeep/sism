    ...
    <div class="bg-white p-8 shadow-xl rounded-lg">
        ...
        <form action="update_password.php" method="POST" class="space-y-6">
            <div>
                ...
                <input type="password" name="sandi_lama" id="sandi_lama" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
            </div>
             <div>
                <label for="sandi_baru" class="block text-sm font-medium text-gray-700">Password Baru</label>
                <input type="password" name="sandi_baru" id="sandi_baru" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
            </div>
             <div>
                <label for="konfirmasi_sandi_baru" class="block text-sm font-medium text-gray-700">Konfirmasi Password Baru</label>
                <input type="password" name="konfirmasi_sandi_baru" id="konfirmasi_sandi_baru" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
            </div>
